...
export default class CompleteSchedule extends React.Component {
  ...
  static navigationOptions = ({ navigation }) => ({
    headerTitle: 'Completed Schedule',
    drawerLabel: 'Completed Schedule',
  ...
  getItem(projectId) {
    this.props.navigation.navigate('CompleteDetailsScreen', { projectId })
  ...
  componentDidMount = () => {
    ...
    AsyncStorage.getItem('USER_ID')
      .then(user_Id => {
        ...
        console.log(user_Id);
        Axios.post('http://attendanceapp.manukahealth.ph/api/project_complete', formData,
          ...
          .then(p => {
            ...
            if (p.data.status == 'true') {
              ...
              Alert.alert('No Completed Schedule Available')
            }
