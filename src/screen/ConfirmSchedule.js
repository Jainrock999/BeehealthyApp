...
export default class ConfirmSchedule extends React.Component {

  static navigationOptions = ({ navigation }) => ({
    headerTitle: 'Accepted Schedule',
    drawerLabel: 'Accepted Schedule',
  ...
  getItem(projectId) {
    this.props.navigation.navigate('ConfirmDetailsScreen', {projectId})
  ...
  componentDidMount = () => {
    ...
    AsyncStorage.getItem('USER_ID')
      .then(user_Id => {
        ...
        console.log(user_Id);
        Axios.post('http://attendanceapp.manukahealth.ph/api/project_detail_accept', formData,
          ...
          .then(p => {
            ...
            if (p.data.status == 'true') {
              ...
              Alert.alert('No Accepted Schedule Available')
            }
